<?php
/**
 * Template name: Componentes homologados
 */
...
<main id="content" class="main-content internal" role="main">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="downloads-intro__image col-md-6 p-0">
                    <div class="downloads-intro-bg" style="background-image: url(<?php echo esc_url(get_template_directory_uri() . '/dist/images/Componentes.png'); ?>)"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="downloads-content">
        <div class="container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-delay="150">
            ...
            <?php //the_field('text_intro_components'); ?>

            <form id="buscarComponente" action="" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-12 text-end">
                        <button type="submit" class="btn btn-md btn-primary" id="btnComponente" data-bs-toggle="modal" data-bs-target="#modalPdf">Buscar</button>
                    </div>
                </div>
            </form>
    ...
    <div class="modal fade" id="modalPdf" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-5 center text-center" id="resultadoComponente">
