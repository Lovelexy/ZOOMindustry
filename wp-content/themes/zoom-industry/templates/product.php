            ...
            <div class="row align-items-center">
                <div class="product-intro__text col-md-6 px-md-5">
                    ...
                    <div class="wrap">
                        <?php if (get_field('title_intro_product')) : ?>
                            <div class="page-title" data-aos-easing="ease-in-out" data-aos-delay="150">
                                <h1><?php the_field('title_intro_product'); ?></h1>
                            </div>
                        <?php endif; ?>
                        <?php if (get_field('text_intro_product')) : ?>
                            <div class="section-desc" data-aos="" data-aos-easing="ease-in-out" data-aos-delay="150">
                ...
                <div class="product-intro__image col-md-6 p-0">
                    <div class="wrap">
                        ...
                        if (!empty($image_prod)) : ?>
                            <figure  data-aos-easing="ease-in-out" data-aos-delay="150">
                    ...
                    <div class="product-support__tabs">
                        <ul class="nav nav-tabs" id="supportTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="drivers-tab" data-bs-toggle="tab" data-bs-target="#drivers" type="button" role="tab" aria-controls="drivers" aria-selected="true">Drivers <span>Verificar de cada produto</span></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="doc-tab" data-bs-toggle="tab" data-bs-target="#doc" type="button" role="tab" aria-controls="doc" aria-selected="false">Documentação <span>Folder do Produto</span></button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="supportTabContent">
                            <div class="tab-pane fade show active" id="drivers" role="tabpanel" aria-labelledby="drivers-tab">
                                <?php if (have_rows('files_support_product')) :
                                    while (have_rows('files_support_product')) : the_row();
                                        $name = get_sub_field('name_file_support');
                                        $file = get_sub_field('file_support');
                                    ?>
                                    <div class="file">
